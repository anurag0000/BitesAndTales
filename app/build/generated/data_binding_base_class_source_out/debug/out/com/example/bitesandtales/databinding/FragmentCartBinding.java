...
public final class FragmentCartBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView addCartRecyclerView;
  ...
  private FragmentCartBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView addCartRecyclerView, @NonNull TextView cartTv,
      @NonNull AppCompatButton proceedButton) {
    this.rootView = rootView;
    this.addCartRecyclerView = addCartRecyclerView;
    this.cartTv = cartTv;
  ...
  public static FragmentCartBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.addCartRecyclerView;
      RecyclerView addCartRecyclerView = ViewBindings.findChildViewById(rootView, id);
      if (addCartRecyclerView == null) {
        break missingId;
      }

      id = R.id.cartTv;
      TextView cartTv = ViewBindings.findChildViewById(rootView, id);
      if (cartTv == null) {
        break missingId;
      }
      ...
      return new FragmentCartBinding((ConstraintLayout) rootView, addCartRecyclerView, cartTv,
          proceedButton);
    }
